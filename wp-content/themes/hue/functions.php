...
function theme_setup() {
	...
	register_nav_menus( array(
		...
		'footer' => __( 'Footer Navigation', 'wesbos' )
	) );
...
/*====================================================================================
		                          custom functions added by Jana Hue 
====================================================================================*/ 


// Removes appearance editor in wp backend

define('DISALLOW_FILE_EDIT', TRUE);



// customizes comment form to remove URL field and show placeholders
...
function modify_comment_form_fields($fields){
    ...
    $fields['email'] = '<p class="comment-form-email">' . '<label for="email">' . __( 'Email' ) . '</label> ' . ( $req ? '<span class="required">*</span>' : '' ) .
                    '<input id="email" name="email" type="text" placeholder="Your email" value="' . esc_attr( $commenter['comment_author'] ) . '" size="20"' . $aria_req . ' /></p>';                
    return $fields;
}
